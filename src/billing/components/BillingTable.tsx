    ...
    return (
        <Grid width={'100%'} p={7} display={"flex"} justifyContent={"center"}>
            <Box width={"10%"} display={"flex"} flexDirection={"column"} alignContent={"center"} borderRadius={'5px 0px 0px 5px'}
                sx={{ backgroundColor: 'white', color: 'black', p: '0px 0px' }}>
                <Typography sx={{ p: '5px 10px', borderBottom: '1px solid black' }} width={'100%'} fontWeight={600}>Date</Typography>
                {bills.map((bill: Bill) => {
                    return (
            ...
            <Box width={"60%"} display={"flex"} flexDirection={"column"} alignContent={"center"}
                sx={{ backgroundColor: 'white', color: 'black', p: '0px 0px' }}>
                <Typography sx={{ p: '5px', borderBottom: '1px solid black' }} width={'100%'} fontWeight={600}>Detail</Typography>
                {bills.map((bill: Bill) => {
                    return (
            ...
            <Box width={"5%"} display={"flex"} flexDirection={"column"} alignContent={"center"}
                sx={{ backgroundColor: 'white', color: 'black', p: '0px 0px' }}>
                <Typography sx={{ p: '5px', borderBottom: '1px solid black' }} width={'100%'} fontWeight={600}>Id</Typography>
                {bills.map((bill: Bill) => {
                    return (
            ...
            <Box width={"10%"} display={"flex"} flexDirection={"column"} alignContent={"center"}
                sx={{ backgroundColor: 'white', color: 'black', p: '0px 0px' }}>
                <Typography sx={{ p: '5px', borderBottom: '1px solid black' }} width={'100%'} fontWeight={600}>Price</Typography>
                {bills.map((bill: Bill) => {
                    return (
            ...
            <Box width={"10%"} display={"flex"} flexDirection={"column"} alignContent={"center"} borderRadius={'0px 5px 5px 0px'}
                sx={{ backgroundColor: 'white', color: 'black', p: '0px 0px' }}>
                <Typography sx={{ p: '5px', borderBottom: '1px solid black' }}width={'100%'} fontWeight={600}>Paid</Typography>
                {bills.map((bill: Bill) => {
                    return (
